...
export default function SplitSekcija() {
  ...
  return (
    <div ref={ref} className={`flex h-screen ${inView ? "animate-slide" : ""}`}>
      <div className="w-1/3 bg-black text-white flex items-center justify-center padding-green-1">
      ...
      <div className="w-1/3 bg-white text-black flex items-center justify-center ">
        <h2 className="text-3xl text-green-600 m-10">
